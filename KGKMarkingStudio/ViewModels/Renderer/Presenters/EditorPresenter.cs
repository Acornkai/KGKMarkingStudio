...
namespace KGKMarkingStudio.ViewModels.Renderer.Presenters;
...
public class EditorPresenter : IContainerPresenter
{
    ...
    private void DrawLayer(object dc, IShapeRenderer renderer, ISelection? selection, LayerContainerViewModel workingLayer)
    {
        ...
        foreach(var shape in workingLayer.Shapes)
        {
