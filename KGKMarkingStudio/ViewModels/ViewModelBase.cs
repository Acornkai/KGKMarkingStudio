...
public abstract partial class ViewModelBase : INotifyPropertyChanged
{
    ...
    protected ViewModelBase(IServiceProvider? serviceProvider)
    {
        ...
        //CutCommand = new RelayCommand<object?>(x => ServiceProvider.GetService<ICli>())
    }
    ...
    public abstract object Copy(IDictionary<object, object>? source);
    ...
    protected void ObserverSelf(PropertyChangedEventHandler handler,
